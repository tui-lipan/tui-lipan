...
fn tick_animated_widgets(tree: &mut NodeTree, dt: Duration) -> (bool, bool, bool) {
...
fn tick_smooth_scrolls(tree: &mut NodeTree, dt: Duration) -> (bool, bool, bool) {
...
impl<C: Component> AppRunner<C> {
    ...
    pub(crate) fn update_animated_widgets(&mut self, dt: Duration) -> (bool, bool, bool) {
        tick_animated_widgets(&mut self.core.tree, dt)
    }

    #[cfg(test)]
    pub(crate) fn update_smooth_scrolls(&mut self, dt: Duration) -> (bool, bool, bool) {
        tick_smooth_scrolls(&mut self.core.tree, dt)
    }
