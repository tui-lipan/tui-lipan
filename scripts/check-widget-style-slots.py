...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("src/widgets/date_picker/mod.rs", "disabled_style"): "legacy raw state style; TODO migrate to StyleSlot",
    ...
    ("src/widgets/draggable_tab_bar/mod.rs", "empty_text_style"): "non-state visual part style",
    ...
    ("src/widgets/draggable_tab_bar/node.rs", "empty_text_style"): "non-state visual part style",
    ...
    ("src/widgets/frame/mod.rs", "focused_style"): "intentional partial overlay for border label groups and labels",
    ...
    ("src/widgets/slider/mod.rs", "disabled_style"): "legacy raw state style; TODO migrate to StyleSlot",
    ...
    ("src/widgets/slider/node.rs", "disabled_style"): "legacy raw state style; TODO migrate to StyleSlot",
